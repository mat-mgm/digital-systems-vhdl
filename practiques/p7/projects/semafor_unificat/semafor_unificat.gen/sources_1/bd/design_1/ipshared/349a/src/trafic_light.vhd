...
ilumination: process(green_c, ambar_c, red_c, green_v, red_v) begin --(clk,green_c, ambar_c, red_c, green_v, red_v)
-- Cotxes
    if green_c = '1' then
        char3 <= "1100";
    elsif ambar_c = '1' then
        char3 <= "1011";
    else --elsif red_c = '1' then
        char3 <= "1010";
    end if;
-- Vianants
    if green_v = '1' then
        char2 <= "1100";
    else --elsif red_v ='1' then
        char2 <= "1010";
    end if;
end process;
